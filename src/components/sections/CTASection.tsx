        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 mx-auto max-w-3xl rounded-2xl border border-white/20 bg-white/5 backdrop-blur px-5 py-4 text-left">
            <p className="text-white/90 text-xs md:text-sm leading-relaxed">
              <span className="font-bold text-white">Garantia WebMarcas:</span> Se o registro for definitivamente arquivado pelo INPI, refazemos o pedido de outra marca sem cobrar novos honorários — o cliente paga apenas as novas taxas oficiais do INPI, quando exigidas.
            </p>
          </div>
