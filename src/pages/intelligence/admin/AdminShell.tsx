...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { to: "graph/impacto", label: "Impact Analysis", icon: Radar, fase: "Fase 09" },
  { to: "graph/nos", label: "Nós manuais", icon: CircleDot, fase: "Fase 09" },
  { to: "graph/auditoria", label: "Auditoria do grafo", icon: History, fase: "Fase 09" },
