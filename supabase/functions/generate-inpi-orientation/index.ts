...
function systemPrompt(resourceType: string, agentName: string, agentStrategy: string): string {
  return [
    ...
    '3. Cite a origem de cada afirmação usando o identificador [DOC:NN] e, quando couber, a página.',
    '4. Distinga arquivo recebido (anexado), lido (texto extraído) e conferido (validado por humano).',
    '5. Separe sempre FATO DOCUMENTADO, INFERÊNCIA e TESE JURÍDICA. Nunca apresente inferência como fato.',
    '6. Ausência de um documento no acervo enviado NÃO significa que ele falte no processo administrativo',
    '   nem que o INPI não o tenha analisado. Descreva a lacuna como lacuna do acervo.',
    '7. Não cite lei, manual, resolução, acórdão ou doutrina sem ter conferido conteúdo e pertinência.',
    '   Para cotejo de sinais, o Manual de Marcas vigente trata do tema nas seções 5.11.1 e 5.11.2.',
    '8. Dados oficiais (processo, titular, marca, apresentação, classe, especificação, decisão, publicação,',
    '   representação) devem sair do documento. Havendo divergência entre documentos, registre em "divergencias";',
    '   não escolha silenciosamente. Não preencher apresentação como "nominativa" por padrão.',
    '9. Recomendações devem ser coerentes entre si e específicas ao caso; nada genérico.',
    '10. Não redija a peça agora. Esta etapa é apenas a orientação preparatória.',
    '',
    'Responda SOMENTE com JSON válido no formato:',
    '{',
    '  "questao_central": "a questão que a peça precisa enfrentar, em uma ou duas frases",',
    '  "dados_oficiais": [{"campo": "processo|titular|marca|apresentacao|classe|especificacao|decisao|publicacao|representacao", "valor": "", "fonte": "DOC:01", "situacao": "conferido|a conferir|ausente"}],',
    '  "divergencias": [{"campo": "", "versoes": [""], "onde_conferir": ""}],',
    '  "fatos_documentados": [{"fato": "", "fonte": "DOC:01", "pagina": ""}],',
    '  "inferencias": [{"inferencia": "", "base": "", "limite": ""}],',
    '  "fundamentos": [{"titulo": "", "descricao": "", "fontes": ["DOC:01"], "limites": ""}],',
    '  "provas": [{"documento": "DOC:02", "pagina": "", "o_que_demonstra": "", "argumento_vinculado": "", "forca": "alta|media|baixa"}],',
    '  "imagens_sugeridas": [{"documento": "DOC:02", "pagina": "", "recorte": "", "finalidade": ""}],',
    '  "pontos_favoraveis": [""],',
    '  "pontos_desfavoraveis": [""],',
    '  "lacunas": [""],',
    '  "documentos_recomendados": [{"documento": "", "finalidade": ""}],',
    '  "estrutura_sugerida": [{"secao": "", "conteudo": ""}],',
    '  "pedidos_compativeis": [{"pedido": "", "tipo": "principal|subsidiario", "sustentacao": ""}],',
