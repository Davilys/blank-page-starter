...
5. Após o deploy, abrir www.webmarcas.net → Recursos INPI → Documentos do caso, anexar um PDF e confirmar que aparece "Lido" (ou "Lido em parte"), sem "Falha na leitura".
...
- Não tenho acesso ao GitHub nem ao servidor de hospedagem; os passos 3 e 4 são executados por você (ou pela conexão GitHub do Lovable, que só você pode autorizar).
